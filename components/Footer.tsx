                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 md:col-span-2">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li><a href="https://hanzo.ai/privacy" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">Privacy Policy</a></li>
                                <li><a href="https://hanzo.ai/terms" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">Terms of Service</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div className="mt-12 border-t border-dark-border pt-8 flex flex-col sm:flex-row justify-between items-center">
                    <p className="text-gray-500 text-sm">&copy; {currentYear} Hanzo Industries Inc. All rights reserved.</p>
                    <div className="flex space-x-6 mt-4 sm:mt-0">
                        <SocialIcon href="https://x.com/hanzoai" aria-label="Hanzo AI on X">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.71v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
                        </SocialIcon>
                         <SocialIcon href="https://github.com/hanzoai" aria-label="Hanzo AI on GitHub">
                         ...
                         <SocialIcon href="https://www.linkedin.com/company/hanzoai" aria-label="Hanzo AI on LinkedIn">
