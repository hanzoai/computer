  ...
  const certifications = [
    {
      ...
      description: "Encryption in transit and at rest, role-based access control, and audit logging"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: "ISO 27001",
      description: "Certification scoped per enterprise engagement"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "HIPAA",
      description: "BAA scoped per enterprise engagement"
    }
  ];
